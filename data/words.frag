...
// NOTE: a breh needs to  face (and fight) the dentist today.
...
void main(void)
{
	...
	d += T(r());add(); d += H(r());add(); d += N(r());add(); d += X(r());space(); add(); d += B(r());add(); d += R(r());add(); d +=E(r());add(); d += H(r());newline();
 d += N(r());add(); d += J(r());add(); d += O(r());add(); d += Y(r()); space();add(); d += U(r());add(); d += R(r());space(); add(); d += D(r());add(); d +=E(r());add(); d += N(r());add(); d += T(r());add(); d += A(r());add(); d += L(r());newline();
 d += R(r());add(); d += A(r());add(); d += P(r()); add(); d += E(r());space();add(); d += T(r());add(); d += O(r());add(); d +=D(r());add(); d += A(r());add(); d += Y(r());newline();
	add(); d += L(r());add(); d += E(r());add(); d += L(r());add(); d += E(r());add(); d += L(r());add(); d += E(r());space();add(); d += K(r());add(); d += T(r());add(); d += N(r());add(); d += X(r());add(); d += B(r());add(); d += Y(r());add(); d += E(r());
